    ...
    <>
      ...
      {!loading && !error && (msdsData.length > 0 || pubchemInfo || chemblInfo || chemBasicInfo) && (
        <div ref={printRef} style={{ padding: '20px' }}>
          ...
          <footer className="no-print" style={{ marginTop: '2rem', textAlign: 'center', padding: '2rem 1rem', color: 'var(--text-muted)', fontSize: '0.9rem', borderTop: '1px solid var(--border-color)' }}>
